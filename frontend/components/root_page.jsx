...
const RootPage = React.createClass({
  ...
  componentWillMount() {
    this.cities = {
          ...
          'San Francisco': [37.76, -122,446, 'http://res.cloudinary.com/dl8lhjvx0/image/upload/v1468000417/a-new-moroccan-restaurant-is-coming-to-san-francisco-_1107_40019880_1_14103245_500_bshn3x.jpg'],
